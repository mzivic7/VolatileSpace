...
print("case: ellipse, same directions, vessel is slower")
print()

ecc = 0.7848720504761658
ma = 5.792703785429235
ea = 5.052894377513412
...
data = predict_enter_coi(vessel_data, body_data, vessel_orbit_center)
print(f"time = {(time.perf_counter() - total_start_time)*1000} ms")
print(f"data = {data}")
